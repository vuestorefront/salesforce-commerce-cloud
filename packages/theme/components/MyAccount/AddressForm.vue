<template>
  <ValidationObserver v-slot="{ handleSubmit }">
    ...
    >
      ...
      >
      <SfInput
        data-cy="address-details-input_id"
        v-model="form.id"
        name="id"
        label="Address Name"
        required
      ...
      <div class="form__horizontal">
        ...
        >
          <SfInput
            data-cy="address-details-input_firstName"
        ...
        >
          <SfInput
            data-cy="address-details-input_lastName"
      ...
      >
        <SfInput
          data-cy="address-details-input_streetName"
      ...
      <SfInput
        data-cy="address-details-input_apartment"
      ...
      <div class="form__horizontal">
        ...
        >
          <SfInput
            data-cy="address-details-input_city"
            v-model="form.city"
            name="city"
            label="City"
            required
      ...
      <div class="form__horizontal">
        ...
        >
          <SfInput
            data-cy="address-details-input_zipCode"
        ...
        >
          <SfSelect
            data-cy="address-details-select_country"
      ...
      >
        <SfInput
          data-cy="address-details-input_phoneNumber"
          v-model="form.phone"
          name="phone"
          label="Phone number"
          required
